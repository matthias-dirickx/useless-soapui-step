...
public class UselessTestRequest extends UselessRequest implements UselessTestRequestInterface {
    private final boolean forLoadTest;
    private UselessTestRequestStep testStep;
    ...
    protected UselessTestRequest(HttpRequestConfig config, UselessTestRequestStep testStep, boolean forLoadTest) {
    ...
    protected void initIcons() {
        ...
        setIconAnimator(new RequestIconAnimator<UselessTestRequest>(this, "/http_request_step.png", "/http_request.png", 4));
    }

    private void initAssertions() {
    	AssertableConfig ac = new AssertableConfig() {
        ...
        assertionsSupport = new AssertionsSupport(testStep, ac);
    }
