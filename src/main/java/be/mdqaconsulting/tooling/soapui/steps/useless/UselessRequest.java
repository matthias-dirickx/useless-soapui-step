...
public class UselessRequest extends AbstractHttpRequest<HttpRequestConfig> implements
        HttpRequestInterface<HttpRequestConfig> {

    private XmlBeansRestParamsTestPropertyHolder params;

    protected UselessRequest(HttpRequestConfig config, boolean forLoadTest) {
    ...
    public UselesssSubmit submit(SubmitContext submitContext, boolean async) throws SubmitException {
        ...
        try {
            UselesssSubmit submitter = new UselesssSubmit(this, getSubmitListeners(),
                    new UselessClientRequestTransport());
