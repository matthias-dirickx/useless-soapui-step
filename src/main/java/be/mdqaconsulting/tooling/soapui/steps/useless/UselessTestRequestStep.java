...
public class UselessTestRequestStep
    extends WsdlTestStepWithProperties
    implements PropertyExpansionContainer,
               UselessTestRequestStepInterface
{    
    @SuppressWarnings("unused")
    private final static Logger log = LogManager.getLogger(UselessTestRequestStep.class);
    private HttpRequestConfig httpRequestConfig;
    private UselessTestRequest testRequest;
    private UselesssSubmit submit;
	
	public UselessTestRequestStep( WsdlTestCase testCase, TestStepConfig config, boolean forLoadTest )
	{
		...
		if( !forLoadTest )
		{
			setIcon( UISupport.createImageIcon( "/report.png" ) );
		}
	}
	
    protected UselessTestRequest buildTestRequest(boolean forLoadTest) {
        return new UselessTestRequest(httpRequestConfig, this, forLoadTest);
    }
    ...
    @Override
    public UselessTestRequestStep clone(WsdlTestCase targetTestCase, String name) {
        beforeSave();
        ...
        UselessTestRequestStep result = (UselessTestRequestStep) targetTestCase.addTestStep(config);
        
        //Attachments are put out of scope - removing it here because the types fight.
    ...
    private class InternalTestPropertyListener extends TestPropertyListenerAdapter {
        ...
        public void propertyAdded(String name) {
            UselessTestRequestStep.this.addProperty(new RestTestStepProperty(getTestRequest().getProperty(name)), true);
        }

        @Override
        public void propertyRemoved(String name) {
            UselessTestRequestStep.this.deleteProperty(name, true);
        }

        @Override
        public void propertyRenamed(String oldName, String newName) {
            UselessTestRequestStep.this.propertyRenamed(oldName);
        }

        @Override
        public void propertyValueChanged(String name, String oldValue, String newValue) {
            UselessTestRequestStep.this.firePropertyValueChanged(name, oldValue, newValue);
        }

        @Override
        public void propertyMoved(String name, int oldIndex, int newIndex) {
            UselessTestRequestStep.this.firePropertyMoved(name, oldIndex, newIndex);
        }
    }
    ...
    private class RestTestStepProperty implements TestStepProperty {
        ...
        public TestStep getTestStep() {
            return UselessTestRequestStep.this;
        }
	...
	@Override
	public UselessTestRequest getTestRequest() {
		return testRequest;
	}
